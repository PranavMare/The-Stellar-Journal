...
// *** Create a Mongoose Documents: ***
  const post = new Post ({
        // parsing and getting:   "postTitle" from ("/compose") line: 8
        title: req.body.postTitle,
        // parsing and getting:   "postBody" from ("/compose") line: 10
...
//       // Tracking and Rendering Posts inside ("post") path
//       res.render("post", {
//         // Key: title           =>   defined as var inside ("/post") line: 3
//         // Value: post.title    =>   defined as var inside ("/home") line: 9
//         title: post.title, 
 
//         // Key: content         =>   defined as var inside ("/post") line: 4
//         // Value: post.content  =>   defined as var inside ("/home") line: 11
//         content: post.content
//       });
//     } 
//   });
